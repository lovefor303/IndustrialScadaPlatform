...
- Preview save/open dialogs use JSON project files; preview drafts are stored under the current user's local application data.
...
| `dotnet test IndustrialScadaPlatform.sln --configuration Release --no-build` | Passed: 175 tests |
