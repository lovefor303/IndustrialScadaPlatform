...
- Rotation handle styling and sensitivity were corrected: the rotation handle now uses the same white fill and DeepSkyBlue border as resize handles, and horizontal drag input maps to 0.05 degrees per pixel for fine adjustments.
